...
test_that("ranking returns a tibble with study progammes", {
  ...
  expect_error(ranking('geologia', stopien = 4), "stopien must be either '1', '2', 'JM'", fixed = TRUE)
})
...
test_that("liczba_absolwentow returns a tibble with number of graduates", {
  ...
  expect_error(liczba_absolwentow('geologia', stopien = 4), "stopien must be either '1', '2', 'JM'", fixed = TRUE)
})
...
test_that("wykres_zarobki_bezrobocie returns a scatter plot", {
  ...
  expect_error(wykres_zarobki_bezrobocie('geologia', stopien = 4), "stopien must be either '1', '2', 'JM'", fixed = TRUE)
})
...
test_that("wyszukaj_studia_tabela returns a tibble with study programmes", {
  ...
  expect_error(wyszukaj_studia_tabela('geologia', stopien = 4), "stopien must be either '1', '2', 'JM'", fixed = TRUE)
})
...
test_that("wyszukaj_studia_mapa returns a maps with study programmes", {
  ...
  expect_error(wyszukaj_studia_mapa('geologia', stopien = 4), "stopien must be either '1', '2', 'JM'", fixed = TRUE)
})
